...
func TestSnapNodes(t *testing.T) {
	...
	nodes := []*Node{
		...
		{Rect: Rect{X: 23.7, Y: 45.2, Width: 50, Height: 50}},
		{Rect: Rect{X: 38.1, Y: 52.9, Width: 50, Height: 50}},
	}
...
func TestSnapToGrid(t *testing.T) {
	...
	nodes := []*Node{
		{Rect: Rect{X: 17.3, Y: 22.8, Width: 50, Height: 50}}, // 12.3, 17.8 relative to (5, 5)
		{Rect: Rect{X: 28.7, Y: 50.2, Width: 50, Height: 50}}, // 23.7, 45.2 relative to (5, 5)
	}
...
func TestSnapNodesAlreadyOnGrid(t *testing.T) {
	...
	nodes := []*Node{
		{Rect: Rect{X: 10.0, Y: 20.0, Width: 50, Height: 50}},
		{Rect: Rect{X: 30.0, Y: 40.0, Width: 50, Height: 50}},
	}
...
func TestSnapNodesBoundaryConditions(t *testing.T) {
	...
	nodes := []*Node{
		{Rect: Rect{X: 15.0, Y: 25.0, Width: 50, Height: 50}}, // Exactly halfway
		{Rect: Rect{X: 14.9, Y: 25.1, Width: 50, Height: 50}}, // Just below/above halfway
		{Rect: Rect{X: 15.1, Y: 24.9, Width: 50, Height: 50}}, // Just above/below halfway
	}
...
func TestSnapNodesVerySmallGrid(t *testing.T) {
	...
	nodes := []*Node{
		{Rect: Rect{X: 12.345, Y: 17.891, Width: 50, Height: 50}},
	}
...
func TestSnapNodesVeryLargeGrid(t *testing.T) {
	...
	nodes := []*Node{
		{Rect: Rect{X: 123.0, Y: 178.0, Width: 50, Height: 50}},
		{Rect: Rect{X: 45.0, Y: 67.0, Width: 50, Height: 50}},
	}
...
func TestSnapNodesZeroPosition(t *testing.T) {
	...
	nodes := []*Node{
		...
		{Rect: Rect{X: 0.1, Y: 0.1, Width: 50, Height: 50}},
	}
